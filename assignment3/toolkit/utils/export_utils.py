...
def export_measures(workspace_path: str, dataset: Dataset, tracker: Tracker, overlaps: list,
    ...
    output = {'tracker_name': tracker.name(), 'results': results, 'average_overlap': average_overlap,
        'total_failures': total_failures, 'average_speed': average_speed, 'average_init_speed': average_init_speed,
        'total_frames': dataset.number_frames}
